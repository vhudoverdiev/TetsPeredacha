...
class ContractorClaimDocxTests(unittest.TestCase):
    ...
    def test_claim_docx_matches_reference_page_and_table_layout(self):
        ...
        self.assertIn('cx="950000"', document_xml)
        self.assertIn('cy="701000"', document_xml)
        ...
        self.assertRegex(first_page_xml, r'<w:spacing w:after="0" w:line="260" w:lineRule="auto"/>.*?</w:p><w:p><w:pPr><w:jc w:val="right"/>.*?<w:t>Исп\.:')
