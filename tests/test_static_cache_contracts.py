...
class StaticCacheContractsTests(unittest.TestCase):
    def test_static_cache_versions_match_current_stylesheets(self):
        self.assertIn("style.css') }}?v=v682-apartment-finish", BASE_TEMPLATE)
        self.assertIn("desktop-only.css') }}?v=v76-objects-three-columns", BASE_TEMPLATE)
        self.assertIn("peredacha-static-v178-apartment-finish", SERVICE_WORKER)
        self.assertIn("/static/style.css?v=v682-apartment-finish", SERVICE_WORKER)
